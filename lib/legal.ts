...
// (`node scripts/setup-db.mjs`) — the real Bosphorus Boat Cruise Tickets privacy
...
const DEFAULT_PRIVACY_POLICY: PrivacyPolicy = {
  ...
  noFollow: false,
  canonicalUrl: "",
  metaTitle: "Privacy Policy | Bosphorus Boat Cruise Tickets",
  metaDescription: "Privacy Policy for Bosphorus Boat Cruise Tickets — how we collect, use, and protect your information.",
  ogTitle: "",
  ogDescription: "",
  ogImage: "",
};
