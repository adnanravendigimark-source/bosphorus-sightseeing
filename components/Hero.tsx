...
export default async function Hero() {
  ...
  return (
    <section
      id="top"
      className="relative flex min-h-[calc(100dvh-4rem)] flex-col justify-center overflow-hidden bg-bosphorus-charcoal text-white"
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-bosphorus-charcoal via-bosphorus-charcoal/70 to-bosphorus-charcoal/30" />
