        ...
        {related.map((post) => (
          ...
          >
            ...
            <div className="flex flex-col justify-center">
              <span className="text-[11px] font-semibold uppercase tracking-wide text-bosphorus-navy">
                {post.category}
              </span>
              <p className="mt-0.5 text-sm font-semibold text-stone-900 group-hover:text-bosphorus-gold">
                {post.title}
              </p>
            </div>
          </Link>
