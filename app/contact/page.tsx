    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-stone-900/10 bg-white p-8 text-center shadow-sm">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-bosphorus-navy/10 text-bosphorus-navy">
          ...
          <div>
            ...
            <a
              ...
              className="mt-1 block break-all font-display text-lg font-semibold text-bosphorus-gold"
            >
              {contact.email}
            </a>
          </div>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 rounded-2xl bg-bosphorus-navy/5 p-8 text-center">
